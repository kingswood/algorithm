...
public class SortTest {
	...
	public static void maxHeap(int[] a, int heapSize, int index) {
		...
		if (leftChild < heapSize && a[leftChild] > a[index]) {
			largestIndex = leftChild;
		}

		if (rightChild < heapSize && a[rightChild] > a[largestIndex]) {
		...
		if (largestIndex != index) {
			...
			// swapped
			maxHeap(a, heapSize, largestIndex);
		}
	...
	public static void main(String[] args) {
		...
		/*
		 * long start1 = System.currentTimeMillis(); bubbleSort(a); long end1 =
		 * System.currentTimeMillis(); System.out.println("Bubble sort cost : "
		 * + (end1 - start1) + " ms.");
		 * 
		 * a = initialArray(count); long start2 = System.currentTimeMillis();
		 * insertionSort(a); long end2 = System.currentTimeMillis();
		 * System.out.println("Insertion sort cost : " + (end2 - start2) +
		 * " ms.");
		 * 
		 */
		...
		System.out.println("Heap sort cost : " + (end5 - start5) + " ms.");
